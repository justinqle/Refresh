...
public class PostDataSource extends PageKeyedDataSource<DefaultPaginator<Submission>, Submission> {
    ...
    PostDataSource(RedditClient redditClient, Subreddit subreddit, Sorting sorting, TimePeriod timePeriod) {
